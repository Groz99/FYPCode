...
// p11, p12, p13, p14, p21, p22, p23, p24, p31, p32, p33, p34, p41, p42, p43, p44, X, Y, Z, Alpha, Beta, Gamma, Temp
...
byte outputvals[23] = {p11, p12, p13, p14, p21, p22, p23, p24, p31, p32, p33, p34, p41, p42, p43, p44, normGyro.XAxis, normGyro.YAxis, normGyro.ZAxis, normAccel.XAxis, normAccel.YAxis, normAccel.ZAxis, temp};

Serial.write(outputvals,23);
